        ...
        <tr>
          <td bgcolor="#1B4965" style="background:#1B4965;padding:24px 32px;">
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <!-- Icon: hosted SVG (works Gmail/Apple Mail/web Outlook); ⊕ alt for Outlook desktop -->
                <td width="52" valign="middle" style="padding-right:14px;">
                  <img src="https://phasexs.com/phase-xs-icon.svg" width="40" height="40" alt="⊕" style="display:block;width:40px;height:40px;" />
                </td>
                <!-- PHASE-XS + subtitle -->
                <td valign="middle">
